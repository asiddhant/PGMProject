...
class Trainer(object):
    ...
    def __init__(self, model, optimizer, result_path, model_name, usedataset, mappings, 
        ...
        self.evaluator = Evaluator(result_path, model_name, mappings).evaluate_srl
    ...
    def train_model(self, num_epochs, train_data, dev_data, test_data, learning_rate, 
        ...
        for epoch in range(1, num_epochs+1):
            ...
            if epoch%self.eval_every==0:
                ...
                if eval_train:
                    best_train_F, new_train_F, _ = self.evaluator(self.model, train_data.copy(), best_train_F, 
