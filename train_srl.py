...
if opt.usemodel == 'BiLSTM_CRF' and opt.dataset == 'conll12':
...
elif opt.usemodel == 'BiLSTM_CRF' and opt.dataset == 'conll05':
    parameters['dpout'] = 0.5
    parameters['wldim'] = 300
    parameters['vbdim'] = 100
    parameters['cpdim'] = 0
...
elif opt.usemodel == 'BiLSTM_CRF' and opt.dataset == 'scisrl':
    parameters['dpout'] = 0.5
    parameters['wldim'] = 300
    parameters['vbdim'] = 100
    parameters['cpdim'] = 0
...
losses, all_F = trainer.train_model(opt.num_epochs, train_data, dev_data, test_data,
